...
export default function Register() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setLoading(true)
    setTimeout(() => {
      localStorage.setItem("synapse_user", JSON.stringify({ email, name, plan: "Free" }))
      toast.success("Аккаунт создан! Создай свой первый трек 🎵")
      navigate("/dashboard")
    }, 600)
  }

  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-10 dark">
      ...
      <Card className="relative w-full max-w-md p-8 bg-zinc-900/80 backdrop-blur border-red-500/20">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Создай аккаунт и начни делать музыку</p>
        </div>
